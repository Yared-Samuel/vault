...
export default function PrintInvoicePage() {
  ...
  return (
    <div className="max-w-2xl mx-auto my-8 bg-white p-10 rounded-xl shadow print:shadow-none print:bg-white print:p-0 relative border border-gray-300 text-gray-900">
      ...
      <table className="w-full mb-4 text-sm border border-gray-300">
        <tbody>
          ...
          (<tr>
            ...
            <td className="border border-gray-300 font-normal bg-gray-100">{transaction.bank.toUpperCase()  || '-'} - {transaction.checkRequestId?.bank.toUpperCase()}</td>
          </tr>)
          }
      ...
      {/* Amount in words */}
      <div className="text-s text-right mb-1 py-4">Amount in words: <span className="font-semibold italic">{birrToWords(amount)}</span></div>
      ...
      <div className="flex flex-col mt-4 text-xs gap-10">
        ...
        <div className=" w-full">
          ...
          <h4 className="mt-1">Prepared By</h4>
        ...
        <div className="w-full">
          ...
          <div className='flex justify-between'>
          <h4 className="mt-1">Recived By</h4>
