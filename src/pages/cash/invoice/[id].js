...
export default function InvoicePage() {
  ...
  return (
    <div className="max-w-2xl mx-auto my-8 bg-white p-10 rounded-xl shadow print:shadow-none print:bg-white print:p-0 relative border border-gray-300 text-gray-900">
      ...
      <div className="text-center font-bold text-lg underline mb-2 tracking-wide">PAYMENT VOUCHER</div>
      <div className="flex justify-between items-center mb-4">
        ...
        {transaction.serialNumber && (
          <div className="text-xs font-semibold">Serial No: <span className="font-mono text-base">{transaction.serialNumber}</span></div>
        )}
      </div>
      {/* Main Info Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2 mb-4 text-sm">
        <div><span className="font-semibold">Recipient:</span> {transaction.to || '-'}</div>
        ...
        <div><span className="font-semibold">Quantity:</span> {transaction.quantity ?? '-'}</div>
      ...
      <table className="w-full border text-xs mb-2">
        ...
        <tbody>
          <tr>
            <td className="border px-2 py-1 min-w-[120px]">{transaction.to || ''}</td>
      ...
      <div className="flex justify-between mt-8 text-xs gap-8">
        <div className="flex flex-col items-center flex-1">
          ...
          <div className="mt-1">Requested By/ Recipient</div>
          <div className="border-b border-gray-400 min-w-[120px] h-6 mt-4" />
          <div className="mt-1">Requested By (Signature)</div>
        </div>
        ...
        <div className="flex flex-col items-center flex-1">
          ...
          <div className="mt-1">Finance Manager</div>
          <div className="border-b border-gray-400 min-w-[120px] h-6 mt-4" />
